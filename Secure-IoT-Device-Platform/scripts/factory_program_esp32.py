...
PRODUCT_PROFILES: tuple[ProductProfile, ...] = (
    ProductProfile("cromaled", "CromaLED", "cromaled-1.0.0", "CromaLED", "CromaLED_Gateway"),
    ProductProfile("area_lz7", "AREA LZ7", "area-lz7-1.0.0", "AREA LZ7", "AREA_LZ7_Gateway"),
    ProductProfile("as7341", "AS7341", "as7341-1.0.0", "AS7341", "AS7341_Gateway"),
)
